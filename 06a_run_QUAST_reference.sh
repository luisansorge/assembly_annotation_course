...
#SBATCH --job-name=QUASTref
#SBATCH --partition=pibu_el8

WORKDIR=/data/users/lansorge/assembly_annotation_course
OUTDIR=/data/users/lansorge/assembly_annotation_course/QUAST_withreference
...
#   -R            : fasta of reference genome
#   --features    : reference annotation file GFF3
apptainer exec --bind /data \
    ...
    --features /data/courses/assembly-annotation-course/references/Arabidopsis_thaliana.TAIR10.57.gff3
